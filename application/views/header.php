...
<html lang="en" style="height: 100%;">
    <head>
        ...
        <!-- CSS CUSTOM STYLE -->
        <link rel="stylesheet" type="text/css" href="<?= base_url() ?>front_assets/css/custom.css?ver=13" media="screen" />
        <!--VENDOR SCRIPT-->
        ...
        $('#vip-meet-greet').on('click',function(e){
            ...
            if(vip_type=="0"){
                Swal.fire({
                    icon: 'info',
                    title: '',
                    html: 'This Meet and Greet Session is for VIP attendees only. Questions? Please contact Victoria at <a href="mailto:victoriap@jfssd.org" style="color: #00008c !important;">victoriap@jfssd.org</a>',
                })
            }else{
