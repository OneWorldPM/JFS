                    ...
                    <form class="form-login" id="frm_login" name="frm_login" method="post" action="<?= base_url() ?>admin/alogin/authentication">
                        <div class="row">
                            <div style="text-align: center">                           
                                <img src="<?= base_url() ?>assets/images/Header_Logos_JFS.png" alt="admin" style="background-color: #674ea0;max-width: 500px" >
                            </div>
                        </div>
                        <fieldset>
                            <?php
                            ...
                            <div class="form-group">
                                <span class="input-icon">
                                    ...
                                    <i class="fa fa-user"  style="color: #674ea0 "></i>
                                </span></span><span id="erroremail" style="color:red;"></span>
                            </div>
                            <div class="form-group form-actions">
                                <span class="input-icon">
                                    <input type="password" class="form-control" id="password" name="password" placeholder="Enter Password">
                                    <i class="fa fa-lock" style="color: #674ea0 "></i>
                                </span></span><span id="errorpassword" style="color:red;"></span>
                            </div>
                            <div class="form-actions">
                                <button type="submit" class="btn form-control" id="btn_login" style="background-color: #674ea0 ">
                                    Log In
                                </button>
                            </div>
