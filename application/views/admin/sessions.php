                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="submit" name="btn_today" class="btn " style="margin-top: 22px; background-color:#674ea0 " id="filter_btn" value="Today">
                                        <input type="submit" name="btn_tomorrow" class="btn " style="margin-top: 22px; background-color:#674ea0 " id="filter_btn" value="Tomorrow">
                                ...
                                <div class="col-md-1">
                                    <input type="submit" name="filter_btn" class="btn " style="margin-top: 22px;background-color:#674ea0 " id="filter_btn" value="Submit">
                                </div>
                                <div class="col-md-2">
